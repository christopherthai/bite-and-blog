        ...
        useEffect(() => {
          ...
          intervalIdTwo = setInterval(() => {
              if(meals.length > 0) {
                ...
                const randomIndexToUpdateTwo = Math.floor(Math.random() * displayImagesTwo.length);
        
                const randomMealImageTwo = meals[Math.floor(Math.random() * meals.length)];
          ...
          return () => {
            ...
            if (intervalIdTwo) {clearInterval(intervalIdTwo); // Cleanup interval on component unmount
            }
          };
